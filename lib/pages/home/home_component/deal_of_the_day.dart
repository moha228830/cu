             ...
             widget.brands.length ==0?ListView(
                ...
                children: <Widget>[
                  InkWell(
                    ...
                    child:Container(color: Colors.grey,width: 30.0.w,height: 7.0.h,),
                  ),
                  SizedBox(width: 10.0),
                  InkWell(
                    onTap: () {
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: Colors.black),                                    borderRadius: BorderRadius.circular(10.0),
                              ...
                              onTap: () {
                                Navigator.push(
                                    ...
                                    PageTransition(
                                        ...
                                        child:ProductListView2(item["id"],"brands",)));

                              },
                              child: Container(
                                child: Image.network(item["img_full_path"],width: 20.0.w,height:7.0.h,fit: BoxFit.fill,
                                   ),
                              ),
                            ),
                          ),
