...
class All extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List  popular =Provider.of<HomeProvider>(context, listen: false).home_popular;
    List new_item =Provider.of<HomeProvider>(context, listen: false).home_new_item;
    List brands =Provider.of<HomeProvider>(context, listen: false).home_brands;
