...
Future<List<Product>> fetchProducts(http.Client client, id, type,page,offset,context) async {
  var fav = Provider.of<HomeProvider>(context, listen: false).favorite.join(',');
  print(fav);
  final response = await client
      .get(Config.url + 'items?type=' + type + '&sub_id=' + id.toString()
      +  '&page=' + page.toString()+ '&offset=' + offset.toString() + "&favorite="+fav.toString() );
