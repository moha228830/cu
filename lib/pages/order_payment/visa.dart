...
class Visa extends StatefulWidget {
  ...
  String name ;
  Visa(this.total,this.price,this.phone,this.govern,this.city,this.address,this.name,this.balance,this.net);
  @override
          ...
          if (result.isSuccess())
          ...
          else
            {
              setState(() {
                ...
                showSimpleNotification(Text(_response, style: TextStyle(fontSize: 12.0.sp,fontFamily: "Cairo"),),
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          backgroundColor: Colors.white,
          title: Text(
           " Visa and Master Card",style: TextStyle(color:Colors.black),
          ),
          titleSpacing: 0.0,
        ),
        body: SafeArea(
          ...
          InkWell(
                onTap: () {
                  if(cardNumber == "" || cvvCode=="" || expiryyear  == "" || cardHolderName==""){
